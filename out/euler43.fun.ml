 ...
 *)
  ...
  let rec a i6 =
    ...
    then let d6 = i6 * 5 in
    if allowed.(d6)
    then ( allowed.(d6) <- false;
           let rec b d7 =
             if d7 <= 9
             then if allowed.(d7)
                  then ( allowed.(d7) <- false;
                         let rec c d8 =
                           if d8 <= 9
                           then if allowed.(d8)
                                then ( allowed.(d8) <- false;
                                       let rec d d9 =
                                         if d9 <= 9
                                         then if allowed.(d9)
                                              then ( allowed.(d9) <- false;
                                                     let rec e d10 =
                                                       if d10 <= 9
                                                       then if allowed.(d10) && (d6 * 100 + d7 * 10 + d8) mod 11 = 0 && (d7 * 100 + d8 * 10 + d9) mod 13 = 0 && (d8 * 100 + d9 * 10 + d10) mod 17 = 0
                                                            then ( allowed.(d10) <- false;
                                                                   let rec f d5 =
                                                                     if d5 <= 9
                                                                     then if allowed.(d5)
                                                                          then ( 
                                                                     ...
                                                                     else ( allowed.(d10) <- true;
                                                                            e (d10 + 1)) in
                                                                     f 0)
                                                            else e (d10 + 1)
                                                       else ( allowed.(d9) <- true;
                                                              d (d9 + 1)) in
                                                       e 1)
                                              else d (d9 + 1)
                                         else ( allowed.(d8) <- true;
                                                c (d8 + 1)) in
                                         d 0)
                                else c (d8 + 1)
                           else ( allowed.(d7) <- true;
                                  b (d7 + 1)) in
                           c 0)
                  else b (d7 + 1)
             else ( allowed.(d6) <- true;
                    a (i6 + 1)) in
             b 0)
    else a (i6 + 1)
