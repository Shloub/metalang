...
int main(void){
  int c = 8;
  std::vector<struct tuple_int_int * > directions( c );
  for (int i = 0 ; i < c; i++)
    if (i == 0)
  {
    struct tuple_int_int * p = new tuple_int_int();
  ...
  {
    struct tuple_int_int * o = new tuple_int_int();
  ...
  {
    struct tuple_int_int * l = new tuple_int_int();
  ...
  {
    struct tuple_int_int * k = new tuple_int_int();
  ...
  {
    struct tuple_int_int * h = new tuple_int_int();
  ...
  {
    struct tuple_int_int * f = new tuple_int_int();
  ...
  for (int j = 0 ; j <= 7; j ++)
  {
    struct tuple_int_int * d = directions.at(j);
