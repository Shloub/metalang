...
Module euler17
  ...
  Sub Main()
    Console.Write((3 + 3 + 5 + 4 + 4) & Chr(10))
    Dim one_to_nine As Integer = 3 + 3 + 5 + 4 + 4 + 3 + 5 + 5 + 4
    Console.Write(one_to_nine & Chr(10))
    Dim one_to_ten As Integer = one_to_nine + 3
    Dim one_to_twenty As Integer = one_to_ten + 6 + 6 + 8 + 8 + 7 + 7 + 9 + 8 + 8 + 6
    ...
    Console.Write(one_to_ninety_nine & Chr(10) & (100 * one_to_nine + one_to_ninety_nine * 10 + 10 * 9 * 99 + 7 * 9 + 3 + 8) & Chr(10))
  End Sub
