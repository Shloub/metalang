                                                        ...
                                                        (let ([tmp (array_init_withenv x 
                                                          (lambda (j) 
                                                            ...
                                                            (block
                                                              ...
                                                              (let ([f (- 1)])
                                                                (list (list i tab x y) f))
                                                              )) internal_env))) (list i tab x y))])
                                                        (block
                                                          (display "\n")
                                                          (let ([e tmp])
                                                            (list (list tab x y) e))
                                                          ))) internal_env))) (list tab x y))])
  (pathfind_aux cache tab x y 0 0))))
(define main (let ([x (read_int )])
               (let ([y (read_int )])
                 (block
                   (display x)
                   (display " ")
