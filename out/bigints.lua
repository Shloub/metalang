    ...
    function print_bigint( a )
      ...
      function bigint_eq( a, b )
        ...
        if a.bigint_sign ~= b.bigint_sign then
          return false
        elseif a.bigint_len ~= b.bigint_len
        then
          return false
        else
          for i = 0,a.bigint_len - 1 do
        ...
        function bigint_gt( a, b )
          ...
          if a.bigint_sign and not(b.bigint_sign) then
            return true
          elseif not(a.bigint_sign) and b.bigint_sign
          then
            return false
          else
          ...
          function add_bigint_positif( a, b )
            ...
            local len = max2_(a.bigint_len, b.bigint_len) + 1
            local retenue = 0
            local chiffres = {}
            for i = 0,len - 1 do
            local tmp = retenue
                ...
                chiffres[k] = 0;
                  ...
                  local retenue = 0
                    ...
                    b.bigint_chiffres[j] * a.bigint_chiffres[i];
                      ...
                      trunc(chiffres[a.bigint_len + b.bigint_len - 1] / 10);
                      chiffres[a.bigint_len + b.bigint_len - 1] =
                      math.mod(chiffres[a.bigint_len + b.bigint_len - 1], 10);
                      for l = 0,2 do
                      ...
                      function bigint_premiers_chiffres( a, i )
                        local len = min2_(i, a.bigint_len)
                      ...
                      function bigint_shift( a, i )
                        ...
                        function mul_bigint( aa, bb )
                          ...
                          elseif bb.bigint_len == 0 then
                            return bb
                          elseif aa.bigint_len < 3 or bb.bigint_len < 3
                          then
                            return mul_bigint_cp(aa, bb)
                          end
                          --[[ Algorithme de Karatsuba --]]
                          local split = trunc(min2_(aa.bigint_len, bb.bigint_len) / 2)
                          ...
                          bigint_shift(sub_bigint(add_bigint(ac, bd),
                          amoinsbcmoinsd), split))
                          ...
                          t[j] = 0;
                            ...
                            function sum_chiffres_bigint( a )
                              ...
                              function bigint_exp( a, b )
                                ...
                                then
                                  return bigint_exp(mul_bigint(a, a),
                                  trunc(b / 2))
                                else
                              ...
                              function bigint_exp_10chiffres( a, b )
                                ...
                                elseif (math.mod(b, 2)) == 0
                                then
                                  return bigint_exp_10chiffres(mul_bigint(a, a),
                                  trunc(b / 2))
                                else
                                  return mul_bigint(a, bigint_exp_10chiffres(a,
                                  b - 1))
                                end
                              end
                                      ...
                                      b[k] = 2;
                                        ...
                                        if b[i] <= maxB
                                          ...
                                          then
                                            n = n + 1;
                                            for l = 2,maxA do
                                            if bigint_eq(a_bigint[l], min0) and
                                            b[l] <= maxB
                                              then
                                                b[l] = b[l] + 1;
                                                a_bigint[l] =
                                                mul_bigint(a_bigint[l],
                                                a0_bigint[l]);
                                              end
                                              end
                                            end
