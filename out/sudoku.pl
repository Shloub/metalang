...
sub sudoku_error{
  ...
  foreach my $x (0 .. 8) {
    $out1 =
    $out1 || $s->[$x] ne 0 && $s->[$x] eq $s->[$x + 9] || $s->[$x] ne 0 && $s->[$x] eq $s->[$x + 9 * 2] || $s->[$x + 9] ne 0 && $s->[$x + 9] eq $s->[$x + 9 * 2] || $s->[$x] ne 0 && $s->[$x] eq $s->[$x + 9 * 3] || $s->[$x + 9] ne 0 && $s->[$x + 9] eq $s->[$x + 9 * 3] || $s->[$x + 9 * 2] ne 0 && $s->[$x + 9 * 2] eq $s->[$x + 9 * 3] || $s->[$x] ne 0 && $s->[$x] eq $s->[$x + 9 * 4] || $s->[$x + 9] ne 0 && $s->[$x + 9] eq $s->[$x + 9 * 4] || $s->[$x + 9 * 2] ne 0 && $s->[$x + 9 * 2] eq $s->[$x + 9 * 4] || $s->[$x + 9 * 3] ne 0 && $s->[$x + 9 * 3] eq $s->[$x + 9 * 4] || $s->[$x] ne 0 && $s->[$x] eq $s->[$x + 9 * 5] || $s->[$x + 9] ne 0 && $s->[$x + 9] eq $s->[$x + 9 * 5] || $s->[$x + 9 * 2] ne 0 && $s->[$x + 9 * 2] eq $s->[$x + 9 * 5] || $s->[$x + 9 * 3] ne 0 && $s->[$x + 9 * 3] eq $s->[$x + 9 * 5] || $s->[$x + 9 * 4] ne 0 && $s->[$x + 9 * 4] eq $s->[$x + 9 * 5] || $s->[$x] ne 0 && $s->[$x] eq $s->[$x + 9 * 6] || $s->[$x + 9] ne 0 && $s->[$x + 9] eq $s->[$x + 9 * 6] || $s->[$x + 9 * 2] ne 0 && $s->[$x + 9 * 2] eq $s->[$x + 9 * 6] || $s->[$x + 9 * 3] ne 0 && $s->[$x + 9 * 3] eq $s->[$x + 9 * 6] || $s->[$x + 9 * 4] ne 0 && $s->[$x + 9 * 4] eq $s->[$x + 9 * 6] || $s->[$x + 9 * 5] ne 0 && $s->[$x + 9 * 5] eq $s->[$x + 9 * 6] || $s->[$x] ne 0 && $s->[$x] eq $s->[$x + 9 * 7] || $s->[$x + 9] ne 0 && $s->[$x + 9] eq $s->[$x + 9 * 7] || $s->[$x + 9 * 2] ne 0 && $s->[$x + 9 * 2] eq $s->[$x + 9 * 7] || $s->[$x + 9 * 3] ne 0 && $s->[$x + 9 * 3] eq $s->[$x + 9 * 7] || $s->[$x + 9 * 4] ne 0 && $s->[$x + 9 * 4] eq $s->[$x + 9 * 7] || $s->[$x + 9 * 5] ne 0 && $s->[$x + 9 * 5] eq $s->[$x + 9 * 7] || $s->[$x + 9 * 6] ne 0 && $s->[$x + 9 * 6] eq $s->[$x + 9 * 7] || $s->[$x] ne 0 && $s->[$x] eq $s->[$x + 9 * 8] || $s->[$x + 9] ne 0 && $s->[$x + 9] eq $s->[$x + 9 * 8] || $s->[$x + 9 * 2] ne 0 && $s->[$x + 9 * 2] eq $s->[$x + 9 * 8] || $s->[$x + 9 * 3] ne 0 && $s->[$x + 9 * 3] eq $s->[$x + 9 * 8] || $s->[$x + 9 * 4] ne 0 && $s->[$x + 9 * 4] eq $s->[$x + 9 * 8] || $s->[$x + 9 * 5] ne 0 && $s->[$x + 9 * 5] eq $s->[$x + 9 * 8] || $s->[$x + 9 * 6] ne 0 && $s->[$x + 9 * 6] eq $s->[$x + 9 * 8] || $s->[$x + 9 * 7] ne 0 && $s->[$x + 9 * 7] eq $s->[$x + 9 * 8];
  }
  my $out2 = ();
  foreach my $x (0 .. 8) {
    $out2 =
    $out2 || $s->[$x * 9] ne 0 && $s->[$x * 9] eq $s->[$x * 9 + 1] || $s->[$x * 9] ne 0 && $s->[$x * 9] eq $s->[$x * 9 + 2] || $s->[$x * 9 + 1] ne 0 && $s->[$x * 9 + 1] eq $s->[$x * 9 + 2] || $s->[$x * 9] ne 0 && $s->[$x * 9] eq $s->[$x * 9 + 3] || $s->[$x * 9 + 1] ne 0 && $s->[$x * 9 + 1] eq $s->[$x * 9 + 3] || $s->[$x * 9 + 2] ne 0 && $s->[$x * 9 + 2] eq $s->[$x * 9 + 3] || $s->[$x * 9] ne 0 && $s->[$x * 9] eq $s->[$x * 9 + 4] || $s->[$x * 9 + 1] ne 0 && $s->[$x * 9 + 1] eq $s->[$x * 9 + 4] || $s->[$x * 9 + 2] ne 0 && $s->[$x * 9 + 2] eq $s->[$x * 9 + 4] || $s->[$x * 9 + 3] ne 0 && $s->[$x * 9 + 3] eq $s->[$x * 9 + 4] || $s->[$x * 9] ne 0 && $s->[$x * 9] eq $s->[$x * 9 + 5] || $s->[$x * 9 + 1] ne 0 && $s->[$x * 9 + 1] eq $s->[$x * 9 + 5] || $s->[$x * 9 + 2] ne 0 && $s->[$x * 9 + 2] eq $s->[$x * 9 + 5] || $s->[$x * 9 + 3] ne 0 && $s->[$x * 9 + 3] eq $s->[$x * 9 + 5] || $s->[$x * 9 + 4] ne 0 && $s->[$x * 9 + 4] eq $s->[$x * 9 + 5] || $s->[$x * 9] ne 0 && $s->[$x * 9] eq $s->[$x * 9 + 6] || $s->[$x * 9 + 1] ne 0 && $s->[$x * 9 + 1] eq $s->[$x * 9 + 6] || $s->[$x * 9 + 2] ne 0 && $s->[$x * 9 + 2] eq $s->[$x * 9 + 6] || $s->[$x * 9 + 3] ne 0 && $s->[$x * 9 + 3] eq $s->[$x * 9 + 6] || $s->[$x * 9 + 4] ne 0 && $s->[$x * 9 + 4] eq $s->[$x * 9 + 6] || $s->[$x * 9 + 5] ne 0 && $s->[$x * 9 + 5] eq $s->[$x * 9 + 6] || $s->[$x * 9] ne 0 && $s->[$x * 9] eq $s->[$x * 9 + 7] || $s->[$x * 9 + 1] ne 0 && $s->[$x * 9 + 1] eq $s->[$x * 9 + 7] || $s->[$x * 9 + 2] ne 0 && $s->[$x * 9 + 2] eq $s->[$x * 9 + 7] || $s->[$x * 9 + 3] ne 0 && $s->[$x * 9 + 3] eq $s->[$x * 9 + 7] || $s->[$x * 9 + 4] ne 0 && $s->[$x * 9 + 4] eq $s->[$x * 9 + 7] || $s->[$x * 9 + 5] ne 0 && $s->[$x * 9 + 5] eq $s->[$x * 9 + 7] || $s->[$x * 9 + 6] ne 0 && $s->[$x * 9 + 6] eq $s->[$x * 9 + 7] || $s->[$x * 9] ne 0 && $s->[$x * 9] eq $s->[$x * 9 + 8] || $s->[$x * 9 + 1] ne 0 && $s->[$x * 9 + 1] eq $s->[$x * 9 + 8] || $s->[$x * 9 + 2] ne 0 && $s->[$x * 9 + 2] eq $s->[$x * 9 + 8] || $s->[$x * 9 + 3] ne 0 && $s->[$x * 9 + 3] eq $s->[$x * 9 + 8] || $s->[$x * 9 + 4] ne 0 && $s->[$x * 9 + 4] eq $s->[$x * 9 + 8] || $s->[$x * 9 + 5] ne 0 && $s->[$x * 9 + 5] eq $s->[$x * 9 + 8] || $s->[$x * 9 + 6] ne 0 && $s->[$x * 9 + 6] eq $s->[$x * 9 + 8] || $s->[$x * 9 + 7] ne 0 && $s->[$x * 9 + 7] eq $s->[$x * 9 + 8];
  }
  my $out3 = ();
  foreach my $x (0 .. 8) {
    $out3 =
