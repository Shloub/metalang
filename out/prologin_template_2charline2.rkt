                                                 ...
                                                 (if (<= i f)
                                                   ...
                                                   (block
                                                     ...
                                                     (let ([b 0])
                                                       (let ([c (- taille2 1)])
                                                         (letrec ([a 
                                                           (lambda (j out_ tableau1 taille1 tableau2 taille2) 
                                                             (if (<= j c)
...
(define main (let ([taille1 (read_int )])
